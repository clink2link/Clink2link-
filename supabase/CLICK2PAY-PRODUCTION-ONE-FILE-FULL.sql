...
-- - Do NOT run fresh-install.sql unless you intentionally want
--   a destructive clean installation.
-- ============================================================
...
select
  ...
  to_regclass('public.link_views') as link_views,
  to_regclass('public.sell_orders') as sell_orders,
  to_regclass('public.withdraws') as withdraws,
  to_regclass('public.transactions') as transactions,
  to_regclass('public.wallet_transactions') as wallet_transactions,
  to_regclass('public.payment_methods') as payment_methods,
  to_regclass('public.referrals') as referrals;
