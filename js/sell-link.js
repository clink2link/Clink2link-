...
document.addEventListener("DOMContentLoaded", () => {
    ...
    async function loadUser() {
        try {
             ...
             * Gagal load profile tidak
             * menghentikan Sell Link.
             */
            try {
                if (
    ...
    function getSoldCount(link) {
        ...
        /*
         * Jika terdapat order paid,
         * gunakan order sebagai sumber
         * utama jumlah penjualan.
         */
    ...
    (async function initSellLink() {
        try {
            ...
            /*
             * Order wajib selesai dimuat
             * sebelum statistik dirender.
             */
            await loadSellOrders();
            await loadSellLinks();
            renderSellStats();
